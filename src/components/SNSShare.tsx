...
const SNSShare: React.FC<Props> = ({ title, link, twitterUserName }) => {
  return (
    <ul css={styles.content}>
      <Helmet>
        <script type="text/javascript" src="//b.st-hatena.com/js/bookmark_button.js" charSet="utf-8" async />
        <script type="text/javascript" src="//widgets.getpocket.com/v1/j/btn.js?v=1" charSet="utf-8" async />
      </Helmet>

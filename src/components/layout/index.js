...
const Layout = ({ location, children }) => {
  ...
  const header = useMemo(
    () => {
      if (isRoot) {
        return (
          <BackgroundImage Tag="div" className={styles.header_container} fluid={headerImageData} backgroundColor={`#8A5E5F`}>
    ...
    [isRoot, isTag, isAbout, headerImageData, rootThumbnailPath]
  )

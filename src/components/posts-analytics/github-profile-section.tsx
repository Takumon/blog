...
const GitHubProfile = () => {
  ...
  return (
    <>
      ...
      <div className={styles.description}>This is GitHub profile.</div>
        ...
        <div className={styles.container__info + ' ' + styles.profile}>
          ...
          <div className={styles.userInfo}>
            <div className={styles.userInfo__content}>
              <FontAwesomeIcon color="#333" size="sm" className={styles.userInfo__content__icon} icon={faEnvelope} />
              {viewer.email}
            </div>
            <div className={styles.userInfo__content}>
              <FontAwesomeIcon color="#333" size="sm" className={styles.userInfo__content__icon} icon={faLink} />
              {viewer.websiteUrl}
            </div>
            <div className={styles.userInfo__content}>
              <FontAwesomeIcon color="#333" size="sm" className={styles.userInfo__content__icon} icon={faMapMarkerAlt} />
              {viewer.location}
            </div>
          </div>
              ...
              <a className={styles.repo} href={repo.url} key={i}>
                ...
                <div className={styles.repo__info}>
                  <div className={styles.repo__info__factor}>
                    <FontAwesomeIcon color="#333" size="sm" className={styles.repo__info__icon} icon={faStar} />
                    {repo.stargazers.totalCount}
                  </div>

                  <div className={styles.repo__info__factor}>
                    <FontAwesomeIcon color="#333" size="sm" className={styles.repo__info__icon} icon={faCodeBranch} />
                    {repo.forkCount}
                  </div>
                </div>
              </a>

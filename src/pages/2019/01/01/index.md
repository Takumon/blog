...
いままで雰囲気でGit使ってたので、ちゃんと勉強するために読みました。
...
2～3日で読破でき、GitHubベースの開発を一人で始められるようになる**本です。
...
GitHubを普段から使っている人にとっては当たり前だけど、初心者は躓く点を説明してくれているのもポイントです。以下例です。
...
* 雰囲気でGit使ってたので、何個か知らないコマンドやオプションを知れました
  * `git rm`
  * `git reset`
  * `git fetch`
  * `git log -p`
...
というわけで次は[Pro Git](https://git-scm.com/book/ja/v2)読みます。

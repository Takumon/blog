...
1. 「入力チェックエラーが1つ以上あったらDB更新をしない」という分岐をどう書くのか
...
上記調査結果により`$util.appendError`で詰めたエラー情報は`$ctx.outErrors`であることがわかっていたので、これらを組み合わせて以下のようにしました。
...
ググってもAppSyncのVTL系の情報はまだあまり見かけませんが、これからも何か知見が見つかれば記事を書きます🍅